...
struct SDRConfig {
    ...
    double rxFrequency=2.4e9, txFrequency=2.4e9, sampleRate=5e6;
    double rxBandwidth=18e6, txBandwidth=18e6;
    double rxGain1=30.0, rxGain2=30.0, txGain=-10.0;
    QString gainMode="manual";
    bool agcEnabled=false, dcOffsetTracking=true, quadratureTracking=true;
    bool firFiltersEnabled=true, enable2R2T=true, enableTX=false;
    int bufferSize=4096;
};

struct DeviceStatus {
    double rssi1=-100, rssi2=-100, temp=0, volt=0, cur=0;
    bool connected=false, streaming=false;
};
...
private:
    void runStreamLoop();
    void runTXStreamLoop();

    bool m_connected=false, m_streaming=false;
    SDRConfig m_config;
    DeviceStatus m_status;
    QThread *m_thread=nullptr, *m_txThread=nullptr;
    void *m_ctx=nullptr, *m_phy=nullptr;
    void *m_rxDev=nullptr, *m_txDev=nullptr;
    void *m_rxBuf=nullptr, *m_txBuf=nullptr;
    QMutex m_mutex;
};
#endif
